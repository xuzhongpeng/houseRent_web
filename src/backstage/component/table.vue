 ...
 <div>
    ...
    <el-header class="el_header">
        <el-input
            ...
            clearable
            v-model="searchText" @keyup.enter="search" class="input-with-select">
       ...
       var that = this;
        tableOperation.operationInfo=this.operationInfo;
           ...
           if(this.operationData.type=="update"){
                for(var index=0;index<this.operationData.rows.length;index++){
                    var item=this.operationData.rows[index];
               // for(var  [index,item] of this.operationData.rows){            
                    ...
                    if(item.type=='picture'){
                        that.getData('house_picController/getById.do',
                        {
                            ...
                            tableOperation.rows[index1].filelist.splice(0,tableOperation.rows[index1].filelist.length);
                            ...
                            this.$message("获取图片出错"+error);
                        }) 
                    }
                } 
            }
            else{
                if(this.operationInfo.is_createID){
